...
```
   valore in memoria: 25          etichetta "eta"
   ┌─────────────┐                    │
   │     25      │  ◀──────────────────
   └─────────────┘

   La variabile NON è la "scatola" che contiene il dato:
   è l'ETICHETTA che ci permette di ritrovarlo e usarlo.
```
...
P arentesi        ()
E sponenti         **
M oltiplicazione   *   e   Divisione  /  //  %   (stessa priorità, da sinistra a destra)
A ddizione         +   e   Sottrazione  -        (stessa priorità, da sinistra a destra)
```
