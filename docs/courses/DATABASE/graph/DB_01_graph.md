...
```mermaid
flowchart LR
    D["📄 Dato<br/>18"] -->|"+ contesto"| I["💡 Informazione<br/>'Marco ha 18 anni'"]
...
```mermaid
flowchart LR
    V["Variabili<br/>in memoria"] --> T["File di<br/>testo"] --> C["File<br/>CSV"] --> F["Fogli di<br/>calcolo"] --> DB["Database<br/>relazionali"]
    style V fill:#dbeafe,stroke:#1e3a8a
    style T fill:#bfdbfe,stroke:#1e3a8a
    style C fill:#93c5fd,stroke:#1e3a8a
    style F fill:#60a5fa,stroke:#1e3a8a,color:#ffffff
    style DB fill:#2563eb,stroke:#1e3a8a,color:#ffffff
```
...
```mermaid
flowchart LR
    C["💻 Google Colab<br/>(temporaneo)"] -->|"mount()"| D["☁️ Google Drive<br/>(permanente)"]
...
```mermaid
flowchart LR
    P1["1️⃣ Mount<br/>Drive"] --> P2["2️⃣ Variabili"] --> P3["3️⃣ Scrivi<br/>.txt"] --> P4["4️⃣ Leggi<br/>.txt"] --> P5["5️⃣ Scrivi<br/>.csv"] --> P6["6️⃣ Leggi<br/>.csv"]
    style P1 fill:#dbeafe,stroke:#1e3a8a
    style P2 fill:#dbeafe,stroke:#1e3a8a
    style P3 fill:#fef3c7,stroke:#92400e
    style P4 fill:#fef3c7,stroke:#92400e
    style P5 fill:#d1fae5,stroke:#065f46
    style P6 fill:#d1fae5,stroke:#065f46
```
