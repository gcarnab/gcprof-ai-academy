...
```mermaid
timeline
    title 70 anni di Intelligenza Artificiale
    1950 : Test di Turing
    1956 : Conferenza di Dartmouth
         : nasce il termine "AI"
    1970-1989 : AI Winter
              : crollano i finanziamenti
    2000-2012 : Rinascita silenziosa
              : più dati, GPU potenti
    2012 : Il Deep Learning esplode
         : AlexNet vince la gara ImageNet
    2017 : Nasce l'architettura Transformer
    2022-2023 : Il momento GPT
              : l'AI generativa arriva a tutti
    2024-2026 : Era degli AI Agent
```
...
<svg viewBox="0 0 600 420" xmlns="http://www.w3.org/2000/svg" style="max-width: 480px; width: 100%; height: auto; display: block; margin: 24px auto; font-family: sans-serif;">
  <circle cx="300" cy="230" r="180" fill="#DBEAFE" stroke="#3B82F6" stroke-width="2"/>
  <circle cx="300" cy="255" r="125" fill="#C7D2FE" stroke="#6366F1" stroke-width="2"/>
  <circle cx="300" cy="280" r="70" fill="#A5B4FC" stroke="#4F46E5" stroke-width="2"/>
  <text x="300" y="80" text-anchor="middle" font-size="22" font-weight="700" fill="#1E3A8A">AI</text>
  <text x="300" y="103" text-anchor="middle" font-size="12" fill="#1E3A8A">Intelligenza Artificiale</text>
  <text x="300" y="150" text-anchor="middle" font-size="17" font-weight="700" fill="#312E81">Machine Learning</text>
  <text x="300" y="278" text-anchor="middle" font-size="14" font-weight="700" fill="#1E1B4B">Deep</text>
  <text x="300" y="296" text-anchor="middle" font-size="14" font-weight="700" fill="#1E1B4B">Learning</text>
  <text x="300" y="390" text-anchor="middle" font-size="11" fill="#475569">Ogni cerchio è contenuto nel precedente: il DL è ML, il ML è AI.</text>
</svg>
...
```
*Ogni "strato" di neuroni trasforma un po' i dati e li passa allo strato successivo, fino al risultato finale.*
...
```mermaid
flowchart TB
    subgraph Chatbot["🗨️ Chatbot classico"]
        direction LR
        A1[Domanda] --> A2[Risposta] --> A3[Fine]
    end
    subgraph Agent["🤖 AI Agent"]
        direction LR
        B1[Obiettivo] --> B2[Pianifica i passaggi]
        B2 --> B3["Usa strumenti<br/>(web · calcolo · file)"]
        B3 --> B4{Risultato verificato?}
        B4 -->|No, correggi| B2
        B4 -->|Sì| B5[Obiettivo raggiunto]
    end
```
*Il chatbot si ferma dopo una risposta; l'AI Agent pianifica, agisce, verifica e — se serve — ripete il ciclo finché non raggiunge l'obiettivo.*
