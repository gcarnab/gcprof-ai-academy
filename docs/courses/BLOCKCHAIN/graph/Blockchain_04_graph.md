...
<svg viewBox="0 0 560 260" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;width:100%;height:auto;display:block;margin:20px auto;font-family:sans-serif;">
  <rect x="180" y="10" width="200" height="130" rx="10" fill="#FEF3C7" stroke="#D97706" stroke-width="2"/>
  <text x="280" y="32" text-anchor="middle" font-size="14" font-weight="700" fill="#92400E">WALLET</text>
  <text x="280" y="60" text-anchor="middle" font-size="13" fill="#92400E">🔑 Chiave Privata</text>
  <text x="280" y="60" text-anchor="middle" font-size="10" fill="#92400E" dy="14">(il vero tesoro da proteggere)</text>
  <text x="280" y="95" text-anchor="middle" font-size="13" fill="#92400E">🔓 Chiave Pubblica</text>
  <text x="280" y="120" text-anchor="middle" font-size="13" fill="#92400E">📍 Indirizzo</text>
  <line x1="280" y1="140" x2="280" y2="175" stroke="#94A3B8" stroke-width="2" marker-end="url(#arrow)"/>
  <defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="4" refY="4" orient="auto"><path d="M0,0 L8,4 L0,8 z" fill="#94A3B8"/></marker></defs>
  <rect x="100" y="180" width="360" height="70" rx="10" fill="#DBEAFE" stroke="#3B82F6" stroke-width="2"/>
  <text x="280" y="205" text-anchor="middle" font-size="12" fill="#1E3A8A">I fondi NON sono qui dentro:</text>
  <text x="280" y="225" text-anchor="middle" font-size="12" fill="#1E3A8A">esistono solo come voci nel registro distribuito</text>
  <text x="280" y="243" text-anchor="middle" font-size="12" fill="#1E3A8A">(la Blockchain stessa)</text>
</svg>
...
```mermaid
flowchart LR
    A["🎲 Chiave Privata<br/>numero segreto enorme e casuale<br/>(generazione casuale)"] --> B["🔓 Chiave Pubblica<br/>curva ellittica, irreversibile<br/>(derivazione matematica)"]
    B --> C["📍 Indirizzo Wallet<br/>es. 0x71C7656E...<br/>(funzione di Hash)"]
```
...
```mermaid
flowchart TB
    S["🌱 Seed Phrase (12-24 parole, BIP-39)<br/>witch collapse practice feed shame..."]
    S -->|derivazione gerarchica BIP-32/44| K1[Chiave privata<br/>Indirizzo 1]
    S -->|derivazione gerarchica BIP-32/44| K2[Chiave privata<br/>Indirizzo 2]
    S -->|derivazione gerarchica BIP-32/44| K3[Chiave privata<br/>Indirizzo 3]
    S -.->|...| K4[Indirizzi<br/>illimitati]
```
...
<svg viewBox="0 0 560 200" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;width:100%;height:auto;display:block;margin:20px auto;font-family:sans-serif;">
  <text x="280" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#334155">CUSTODIA DELLE CHIAVI</text>
  <rect x="10" y="35" width="260" height="150" rx="10" fill="#FEE2E2" stroke="#DC2626" stroke-width="2"/>
  <text x="140" y="60" text-anchor="middle" font-size="14" font-weight="700" fill="#991B1B">Custodial</text>
  <text x="140" y="80" text-anchor="middle" font-size="11" fill="#991B1B">terze parti gestiscono</text>
  <text x="140" y="95" text-anchor="middle" font-size="11" fill="#991B1B">le chiavi per te</text>
  <text x="140" y="125" text-anchor="middle" font-size="12" fill="#166534">✅ Più semplice</text>
  <text x="140" y="150" text-anchor="middle" font-size="12" fill="#92400E">⚠️ Devi fidarti di un terzo</text>
  <rect x="290" y="35" width="260" height="150" rx="10" fill="#DCFCE7" stroke="#16A34A" stroke-width="2"/>
  <text x="420" y="60" text-anchor="middle" font-size="14" font-weight="700" fill="#14532D">Non-Custodial</text>
  <text x="420" y="80" text-anchor="middle" font-size="11" fill="#14532D">l'utente gestisce</text>
  <text x="420" y="95" text-anchor="middle" font-size="11" fill="#14532D">le proprie chiavi</text>
  <text x="420" y="125" text-anchor="middle" font-size="12" fill="#166534">✅ Pieno controllo</text>
  <text x="420" y="150" text-anchor="middle" font-size="12" fill="#92400E">⚠️ Piena responsabilità personale</text>
</svg>
...
```mermaid
flowchart LR
    A["① Costruzione<br/>mittente, destinatario,<br/>importo, fee"] --> B["② Firma<br/>con CHIAVE PRIVATA<br/>del mittente"]
    B --> C["③ Trasmissione<br/>alla rete P2P"]
    C --> D["④ Verifica<br/>con CHIAVE PUBBLICA<br/>del mittente"]
    D --> E["⑤ Inclusione nel blocco<br/>se la firma è valida"]
```
