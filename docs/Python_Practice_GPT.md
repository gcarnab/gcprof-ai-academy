...
Ogni modulo dovrà essere sviluppato includendo:
- Obiettivi didattici
- Prerequisiti
- Spiegazione teorica approfondita
- Diagrammi concettuali (Markdown)
- Esempi progressivi ampiamente commentati
- Errori comuni
- Best practice
- Esercizi guidati
- Esercizi autonomi
...
> Nota: l'espansione completa di tutti gli 11 moduli supera ampiamente il limite di testo gestibile in una singola risposta (centinaia di pagine Markdown). Per questo motivo questo file contiene la struttura completa da utilizzare come base.
