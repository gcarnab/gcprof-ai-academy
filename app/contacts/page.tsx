        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-between space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold uppercase tracking-wider text-muted-foreground">I miei canali ufficiali</h3>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <a 
                  ...
                  className="flex items-center gap-3 rounded-xl border bg-background p-4 shadow-sm transition hover:border-red-200 hover:bg-red-50/30 group"
                >
                  <span className="text-2xl">📺</span>
                  <div>
                    <div className="font-semibold text-foreground group-hover:text-red-600 transition-colors">YouTube</div>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl border bg-background p-4 shadow-sm transition hover:border-blue-200 hover:bg-blue-50/30 group"
                >
                  <span className="text-2xl">💼</span>
                  <div>
                    <div className="font-semibold text-foreground group-hover:text-blue-700 transition-colors">LinkedIn</div>
                    <div className="text-xs text-muted-foreground">Profilo professionale</div>
                  </div>
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl border bg-background p-4 shadow-sm transition hover:border-gray-900 hover:bg-muted group"
                >
                  <span className="text-2xl">🐙</span>
                  <div>
                    <div className="font-semibold text-foreground transition-colors">GitHub</div>
                    <div className="text-xs text-muted-foreground">Repository & Progetti</div>
                  </div>
                </a>
{/*
                <div className="flex items-center gap-3 rounded-xl border bg-background p-4 shadow-sm">
                  <span className="text-2xl">📍</span>
                  <div>
                    <div className="font-semibold text-foreground">Ricevimento studenti</div>
                    <div className="text-xs text-muted-foreground">Classi prime e seconde</div>
                  </div>
                </div>
 */}
              </div>
          ...
          <div className="rounded-2xl border border-border bg-background p-8 shadow-sm lg:p-10">
            <h2 className="text-2xl font-bold text-foreground mb-6">Invia un messaggio rapido</h2>
